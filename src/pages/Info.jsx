          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-5xl md:text-7xl font-bold text-white mb-8">
                {data?.title || 'ANSWERS FOR EVERY QUESTION'}
              </h1>
              <p className="text-xl md:text-2xl text-gray-300">
                {data?.subtitle || 'Explore our services, process, and support for your marketing and creative needs.'}
              </p>
            </div>
            ...
            {/* FAQ Section - Keep some static content for structure */}
